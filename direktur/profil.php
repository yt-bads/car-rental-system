<?php
// direktur/profil.php
// Halaman Profil Direktur — Rental Mobil PT. Wildan Abadi Jaya
...
$page_title = 'Profil Pengguna | Direktur';
$extra_css  = 'admin.css';
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb small mb-0">
                    <li class="breadcrumb-item"><a href="laporan.php">Dashboard</a></li>
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        <div class="avatar-circle mx-auto mb-3" style="width: 72px; height: 72px; font-size: 2rem; background: linear-gradient(135deg, var(--color-warning), #ff9800);">
                            <?= strtoupper(substr($_SESSION['nama'] ?? 'D', 0, 1)) ?>
                        </div>
                        <h5 class="fw-bold mb-1"><?= htmlspecialchars($_SESSION['nama'] ?? 'Direktur') ?></h5>
                        <span class="badge bg-warning text-dark text-uppercase px-2.5 py-1" style="font-size: 0.75rem;"><?= htmlspecialchars($_SESSION['role'] ?? 'direktur') ?></span>
                    </div>
